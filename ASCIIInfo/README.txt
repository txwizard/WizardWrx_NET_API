...
|------------|---------|-------------------------------------------------------|
| 2018/10/07 | 7.1     | Override ToString to render all three representations |
...
| 2017/08/04 | 7.0     | Relocated to the constellation of core libraries that |
|            |         | began as WizardWrx.DllServices2.dll.                  |
| 2016/06/12 | 3.0     | 1) Break the dependency on WizardWrx.SharedUtl2.dll,  |
